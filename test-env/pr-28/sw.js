...
const APP_SHELL = [
  ...
  './images/bent-over-rows-dumbbell-finish.svg',
  './images/bent-over-rows-dumbbell-start.svg',
  './images/bicep-curl-finish.svg',
  './images/bicep-curl-start.svg',
  ...
  './images/heel-raise-single-leg-finish.svg',
  './images/heel-raise-single-leg-start.svg',
  './images/hip-abduction-finish.svg',
  './images/hip-abduction-start.svg',
  './images/hip-extension-finish.svg',
  './images/hip-extension-start.svg',
  './images/pallof-press-standing-finish.svg',
  './images/pallof-press-standing-start.svg',
  './images/pnf-d2-finish.svg',
  './images/pnf-d2-start.svg',
  './images/scapular-retraction-prone-arms-out-t-finish.svg',
  './images/scapular-retraction-prone-arms-out-t-start.svg',
  './images/scapular-retraction-prone-arms-overhead-lift-finish.svg',
  './images/scapular-retraction-prone-arms-overhead-lift-start.svg',
  './images/scapular-retraction-prone-arms-side-finish.svg',
  './images/scapular-retraction-prone-arms-side-lift-finish.svg',
  './images/scapular-retraction-prone-arms-side-lift-start.svg',
  './images/scapular-retraction-prone-arms-side-start.svg',
  './images/sit-to-stand-lower-extremity-bias-finish.svg',
  './images/sit-to-stand-lower-extremity-bias-start.svg',
